...
export class SoporteMxComponent implements OnInit {
  ...
  fields:any = [
    ...
    { name: 'Llamadas Desbordadas',field: 'inDesbordadas',tipo: 'numero' },
    { name: 'Llamadas Abandonadas',field: 'inAbandonadas',tipo: 'numero' },
    { name: 'Desborde',    field: 'pDesborde',    tipo: 'perc' },
