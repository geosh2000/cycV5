...
@Component({
  selector: 'app-venta-por-canal-mt',
  templateUrl: './venta-por-canal-mt.component.html',
  styles: [],
  providers: [CurrencyPipe]
})
export class VentaPorCanalMtComponent implements OnInit {
  ...
  search( flag? ){
    ...
    this._api.restfulGet( `${inicio}/${fin}/${sv}/${type}/${td}/${prod}/${this.isPaq}/${ ammount }/${ hour }/1`, 'venta/getVentaPorCanalSV')
            .subscribe( res =>{
