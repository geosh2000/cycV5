...
@Component({
  selector: 'app-pdv-super-assign',
  templateUrl: './pdv-super-assign.component.html',
  styles: [`
    .dragOver {
      background: #12479b;
      color: white
...
export class PdvSuperAssignComponent implements OnInit {
  ...
  getSupList(){
    ...
    this._api.restfulGet( `${this.selectedCountry}/${this.selectedDate}`,'Lists/pdvSupList' )
              .subscribe( res => {
  ...
  getModules(){
    ...
    this._api.restfulGet( `${this.selectedCountry}/${this.selectedDate}`,'Lists/pdvModuleList' )
              .subscribe( res => {
  ...
  assign(id, sup, callback){
    ...
    this._api.restfulPut( params,'Config/pdvSupAssign' )
              .subscribe( res => {
